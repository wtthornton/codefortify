...
async function analyzeProjectScorer() {
  const refactor = new AutoRefactorSuggestions();
  
  try {
    console.log('🔍 Analyzing ProjectScorer.js for refactoring...\n');
    
    const plan = await refactor.generateRefactoringPlan('./src/scoring/ProjectScorer.js');
