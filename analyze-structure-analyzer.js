...
async function analyzeStructureAnalyzer() {
  const refactor = new AutoRefactorSuggestions();
  
  try {
    console.log('🔍 Analyzing StructureAnalyzer.js for refactoring...\n');
    
    const plan = await refactor.generateRefactoringPlan('./src/scoring/analyzers/StructureAnalyzer.js');
